        ...
        <ScrollView contentContainerStyle={styles.content}>
          <View style={styles.combinationGrid}>
            {diceImageNames.map((imageName) => (
              <Pressable
                ...
                style={[
                  styles.combinationButton,
                  selected === imageName && styles.selectedCombination,
                ]}
                accessibilityRole="button"
              ...
              >
                <Text
                  style={[
                    styles.combinationText,
                    selected === imageName && styles.selectedCombinationText,
                  ]}
                >
                  {imageName.toString()[0] + ' - ' + imageName.toString()[1]}
                </Text>
              </Pressable>
            ))}
          </View>
          ...
          {selected !== null && (
            <View style={styles.selectedContent}>
              <Text style={styles.selectedTitle}>
                Combinação {selected.toString()[0] + ' - ' + selected.toString()[1]}
              </Text>
              <Image
              ...
              <View style={styles.actions}>
                ...
                <Pressable
                  style={[styles.actionButton, styles.cameraButton, saving && styles.disabled]}
                  onPress={openCamera}
                  disabled={saving}
                  accessibilityRole="button"
          ...
          {feedback && (
            <Text
              ...
              style={[styles.feedback, feedback.kind === 'error' ? styles.error : styles.success]}
            >
              {feedback.text}
            </Text>
          )}
