...
export function KeyArtwork({ label, size }: { label: string; size: number }) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 68 68" style={{ position: 'absolute', left: 0, top: 0, pointerEvents: 'none' }}>
      ...
      {label === '+/−' && <>
        <Line x1="19" y1="32" x2="25" y2="32" stroke={WHITE} strokeWidth="2.3" strokeLinecap="round" />
        <Line x1="22" y1="29" x2="22" y2="35" stroke={WHITE} strokeWidth="2.3" strokeLinecap="round" />
        <Line x1="30" y1="44" x2="39" y2="24" stroke={WHITE} strokeWidth="2.3" strokeLinecap="round" />
        <Line x1="43" y1="36" x2="49" y2="36" stroke={WHITE} strokeWidth="2.3" strokeLinecap="round" />
      </>}
      {label === '=' && <>
        <Line x1="26" y1="29" x2="42" y2="29" stroke={WHITE} strokeWidth="5" strokeLinecap="square" />
        <Line x1="26" y1="39" x2="42" y2="39" stroke={WHITE} strokeWidth="5" strokeLinecap="square" />
      </>}
    </Svg>
  );
}
